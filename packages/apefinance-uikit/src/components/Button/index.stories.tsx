...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="http://apefinance.org/x" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="http://apefinance.org/x" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
